...
class DialogueBox extends FlxSpriteGroup
{
	...
	var commands:Array<String> = [
		'playsound', 'startmusic', 'endmusic', 'glitch', 'autoskip', 'hideright', 'hideleft', 'crash', 'showbackgroundimage', 'hidebackground', 'fadeout',
		'fadein', 'hidedialogue', 'hidebgfade', 'showbgfade', 'flash', 'shake', 'fadecg', 'swapstyle', 'styleswap', 'playcutscene'
	];
